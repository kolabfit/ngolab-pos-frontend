                            ...
                            <div class="card-body">
                                <div class="d-flex mb-3">
                                    <?php
                                        ...
                                        $outletId = isset($outletId) ? htmlspecialchars($outletId) : '';
                                    ?>
                                    <form action="mendaftarkanProdukOutlet.php" method="GET">
                                        <input type="hidden" name="outletId" value="<?= $outletId ?>">
                                        <button class="btn btn-primary shadow btn-xs sharp me-1" type="submit">
                                ...
                                <div class="table-responsive">
                                    <table id="example5" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            $outletId = $_GET['outletId'];
                                            // Fetch data from API
                                            $url = "http://127.0.0.1:8000/api/outlets/" . $outletId . "/products";
                                            $products = [];
                                            ...
                                            if ($response !== false) {
                                                ...
                                                // Validate if 'data' key exists and is an array
                                                if (isset($products['data']) && is_array($products['data'])) {
                                                    foreach ($products['data']['outlet']['products'] as $product) {
                                            ?>
                                                        <tr>
                                                            <td>
                                                                <div class="form-check custom-checkbox ms-2">
                                            ...
                                            <?php
                                                    ...
                                                    // Handle case where 'data' key does not exist or is not an array
                                                    echo "<tr><td colspan='7'>No products found.</td></tr>";
                                                }
                                            } else {
                                                // Handle API error
                                                echo "<tr><td colspan='7'>Unable to fetch data from the API. Please check the API endpoint.</td></tr>";
                                            }
                                            ?>
                                        </tbody>
                                    </table>
