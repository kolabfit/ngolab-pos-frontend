...
<head>
	...
	<!-- PAGE TITLE -->
	<title>Kelola Jenis Voucher</title>
...
<body data-page="manageVoucherType.html">
                ...
                <div class="row">
					<div class="col-12">
                        <div class="card">
                            <div class="card-body">
								<div class="d-flex">
									<a href="#" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-plus"></i></a>
								</div>
